...
print(wrapped_text) # In the output, the last line may be shorter than 20 characters if the total length of the string is not a multiple of 20.
...
print(filled_text) #  In the output, the last line may be shorter than 20 characters if the total length of the string is not a multiple of 20.
...
print(shortened_text) # In the output, the string is shortened to a maximum width of 10 characters, and an ellipsis is added at the end to indicate that the text has been truncated.
